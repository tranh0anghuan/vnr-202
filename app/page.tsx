                ...
                <div className="space-y-4">
                  <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                    ...
                    <ul className="text-sm text-yellow-700 space-y-1">
                      <li>• 5 chữ cái</li>
                      <li>
                        • Hiệp định thương mại mở rộng thị trường với Liên minh
                        Châu Âu
                      </li>
                      <li>• Tương tự CPTPP, là cam kết hội nhập quốc tế</li>
                      <li>• Tìm trong phần Hành trình đổi mới</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                      <li>• 3 chữ cái</li>
                      <li>
                        • Dòng vốn quốc tế vào Việt Nam, là thước đo niềm tin
                        của nhà đầu tư
                      </li>
                      <li>
                        • Thúc đẩy công nghiệp chế tạo và chuỗi cung ứng công
                        nghệ cao
                      </li>
      ...
      <AnimatedSection className="py-20 px-4 bg-vn-gradient-2 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="relative">
            {/* Đường timeline chính - ĐÃ SỬA: đường thẳng đứng ở giữa */}
            <motion.div
              ...
              {timelineEvents.map((event, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Điểm kết nối trên timeline */}
                    <div
                      className={`absolute ${
                        index % 2 === 0 ? "-right-2" : "-left-2"
                      } top-1/2 transform -translate-y-1/2 w-6 h-6 bg-yellow-400 rounded-full shadow-lg z-20`}
                    ></div>
                  </motion.div>

                  {/* Đường nối ngang từ năm đến card - ĐÃ SỬA: đường ngang thẳng */}
                  <div
                    className={`absolute top-1/2 transform -translate-y-1/2 w-16 h-0.5 bg-yellow-400 z-10 ${
                  ...
                  {/* Card nội dung */}
                  <div
                    className={`flex-1 ${index % 2 === 0 ? "ml-24" : "mr-24"}`}
                  >
                    <motion.div
                ...
                >
                  ...
                  <div className="relative p-8">
                    ...
                    >
                      {index === 0 ? (
                        <>
                          Việt Nam tiếp tục thu hút mạnh mẽ dòng vốn FDI với
